...
@section('intro')
    <h1 class="animation-slideDown"><strong>Search the story</strong></h1>
@stop

@section('content')

	<div class="site-block">
		<h1>Result search for "<span style="color: blue; font-style: italic; font-weight: normal;">{{ $title }}</span>"</h1>
	</div>
    <!-- Blog Post -->
